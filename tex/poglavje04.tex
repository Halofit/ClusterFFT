...
RPIs & n[s] = 5  & n[s] = 20  & n[s] = 60  & n[s] = 180  \\ \cline{1-5}
1 &   &   &   &   \\
  &   &   &   &   \\
  &   &   &   &   \\ \cline{1-5}
2 & 14,50 & 44,69 &  &  \\
  & 14,08 & 48,99 &  &  \\
  & 13,08 & 48,35 &  &  \\ \cline{1-5}
4 & 10,67 & 27,85 & 94,49 & 193,99 \\
  & 10,66 & 28,50 & 93,18 & 203,01 \\
  & 11,06 & 27,15 & 97,29 & 201,75 \\ \cline{1-5}
\end{tabular}
\end{table}

\begin{table}[h]
\begin{tabular}{l|cccc}
RPIs & N[f] = 5  & N[f] = 20  & N[f] = 60  & N[f] = 180  \\ \cline{1-5}
1 &   &   &   &   \\
  &   &   &   &   \\
  &   &   &   &   \\ \cline{1-5}
...
Še vedno nismo opravili vseh meritev, ki jih nameravamo. V tem tednu bomo izvajali eksperimente z razlièno velikimi bremeni in v razliènih okolišèinah. Za rezultat meritev bomo upoštevali najmanjšo, najveèjo in povpreèno meritev.
