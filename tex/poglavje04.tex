...
Zaradi naših predznanj lahko storitev za strežnik\ref{fig:miselni}, katerega ustroj in delovanje poznamo, bolje optimiziramo, kot oblaèno storitev, kar je prav tako vredno preveriti.
